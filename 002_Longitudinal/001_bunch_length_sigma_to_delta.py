...
for i_part in range(n_part):
    print('%f sigma bunch length is delta = %f'%(sigma_tbt[0,i_part]/rms_bunch_length, max(delta_tbt[:,i_part])))
#plt.close('all')
#
fig2 = plt.figure(2)
ax2 = fig2.add_subplot(1, 1, 1)
ax2.plot(Dsigma_wrt_CO,Qsigma,'b',label='Tunes from tracking')
