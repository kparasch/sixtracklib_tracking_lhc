...
r_max_sigma = 20.
r_step_sigma = 0.1
N_r_footp = (r_max_sigma-r_min_sigma)//r_step_sigma+1
theta_min = 0.
theta_max = np.pi/2.
theta_step = np.pi*3./180.
N_theta_footp = (theta_max-theta_min)/theta_step+1
n_turns_beta = 150
...
xy_norm = footprint.initial_xy_polar(r_min=r_min_sigma, r_max=r_max_sigma, r_N=N_r_footp,
...
with open('DpxDpy_for_footprint_for_mad_line.pkl', 'wb') as fid:
    pickle.dump({
